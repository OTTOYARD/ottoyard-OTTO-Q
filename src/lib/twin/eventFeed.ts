...
//
// PULSE and OrchestrAV carry this file verbatim from the twin cockpit (ottoyarddepot-sim src/lib/eventFeed.ts), so all
// three cockpits word every event the same way. Change it there first.
