...
// In this cockpit the feed row is the shared twin layer's ActivityRow (./cards); the rest of this file is the
// twin's src/lib/decisionText.ts, verbatim.
import type { ActivityRow as ActivityFeedRow } from "./cards";
